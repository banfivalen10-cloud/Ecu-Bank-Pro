    ...
    return (
      <div className="min-h-screen flex flex-col bg-[#050811] text-slate-100">
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1 w-full">
          ...
          <section className="p-5 sm:p-7 rounded-2xl border border-white/15 bg-[#07101a]/90 shadow-2xl shadow-cyan-950/20"><p className="text-sm text-slate-300 leading-relaxed">ECM Titanium es un editor profesional para trabajar con drivers, mapas y compatibilidad de centralitas. Aquí encontrás el instalador completo y las versiones disponibles para descargar.</p><div className="mt-5 p-4 rounded-xl bg-slate-950/80 border border-cyan-500/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4"><div><div className="text-[10px] uppercase tracking-widest text-cyan-300 font-bold">DESCARGA OFICIAL</div><h2 className="text-lg font-bold text-white mt-1">ECM Titanium — Instalador completo</h2><p className="text-xs text-slate-400 mt-1">Archivo alojado en MEGA. Haz clic abajo para descargar el instalador.</p></div><Button onClick={openEcmDownload} className={isVip ? "bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold" : "bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold"}>{isVip ? <><Download className="h-4 w-4 mr-2" /> Descargar ECM Titanium</> : <><Lock className="h-4 w-4 mr-2" /> Desbloquear descarga</>}</Button></div></section>
