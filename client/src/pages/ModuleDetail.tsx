      ...
      <div className="min-h-screen flex flex-col bg-[#050811] text-slate-100">
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1 w-full">
          ...
          <section className="mt-6 rounded-2xl border border-white/10 bg-slate-950/70 p-4 sm:p-5"><div className="mb-4"><div className="text-[10px] uppercase tracking-widest text-cyan-300 font-bold">SOFTWARE INCLUIDO</div><h2 className="text-lg font-bold text-white mt-1">Programas y enlaces del paquete</h2></div><div className="space-y-3">{[
            ...
            { title: "Tecnocar", subtitle: "Programa de reprogramación", link: "https://drive.google.com/drive/folders/1xbE3EZnm1t5L7Txn1f63-XAELGpctU0j" },
            { title: "Mecánica 2020", subtitle: "Descarga las dos partes y colócalas en la misma carpeta. Contraseña: mecanica84494460", link: "https://drive.google.com/drive/folders/1xbE3EZnm1t5L7Txn1f63-XAELGpctU0j" },
            { title: "Mecánica 2020 (P1)", subtitle: "Primera parte", link: "https://drive.google.com/drive/folders/1xbE3EZnm1t5L7Txn1f63-XAELGpctU0j" },
            { title: "Mecánica 2020 (P2)", subtitle: "Segunda parte", link: "https://drive.google.com/drive/folders/1xbE3EZnm1t5L7Txn1f63-XAELGpctU0j" },
            { title: "Dicatec 3.3", subtitle: "Software incluido", link: "https://drive.google.com/drive/folders/1xbE3EZnm1t5L7Txn1f63-XAELGpctU0j" },
            { title: "Adobe Acrobat Reader", subtitle: "Programa obligatorio: Adobe Reader 9.0 o superior para leer los PDF.", link: "https://get.adobe.com/reader/" },
            { title: "K-Suite (MEGA)", subtitle: "Suite de herramientas", link: "https://mega.nz/" },
