...
const moduleOneFolders = [
  { id: "software", name: "01 Software y Herramientas", count: 18, description: "Programas, instaladores y utilidades profesionales" },
  { id: "remap", name: "02 Archivos de Remap", count: 14200, description: "Archivos originales, Stage y soluciones de reprogramación" },
  { id: "damos", name: "03 DAMOS y Map Packs", count: 3980, description: "DAMOS, A2L, Mappacks y definiciones por ECU" },
  { id: "manuales", name: "04 Manuales y Curso", count: 36, description: "Formación, guías técnicas y documentación" },
  { id: "bonus", name: "05 Bonus", count: 174, description: "Material adicional y recursos extra" },
  { id: "allfilesecure", name: "allfilesecure-home", count: 1, description: "Carpeta indexada de acceso seguro" },
  { id: "velora", name: "velora-labs-home", count: 1, description: "Carpeta indexada de laboratorio" },
];
...
export default function ModuleDetail() {
  ...
  const handleOpenDrive = () => {
    toast.success("Enlace de Google Drive preparado", {
      description: "Cuando conectemos la carpeta real, este botón abrirá su ubicación oficial.",
    });
  };
            ...
            {!selectedFolder ? (
              ...
              <div className="px-5 sm:px-6 pb-6">
                ...
                <div className="p-6 rounded-xl border border-dashed border-cyan-500/30 bg-cyan-500/5 text-center">
                  ...
                  <Button onClick={() => setLocation(`/drive-explorer?module=${moduleId}`)} variant="outline" className="mt-4 border-cyan-500/30 text-cyan-300 hover:bg-cyan-500/10">Abrir explorador de archivos</Button>
                </div>
              </div>
            )}
          </section>
